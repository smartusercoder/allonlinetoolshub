...
const units = {
  lux: { name: "Lux (lx)", multiplier: 1 },
  footcandle: { name: "Foot-Candle (fc)", multiplier: 10.764 },
  phot: { name: "Phot (ph)", multiplier: 10000 },
};

export default function IlluminanceConverter() {
  const [value, setValue] = useState("1");
  const [fromUnit, setFromUnit] = useState("lux");
  const [toUnit, setToUnit] = useState("footcandle");

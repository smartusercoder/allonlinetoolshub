...
const TimeAdditionCalculator = () => {
  ...
  const calculate = () => {
    const totalMinutes = (parseInt(hours1 || "0") * 60 + parseInt(minutes1 || "0")) + 
  ...
  return (
    <ToolLayout title="Time Addition Calculator" description="Add time durations together">
      <Card className="p-6">
        <div className="space-y-4 max-w-md mx-auto">
          ...
          <Button onClick={calculate} className="w-full">Add Times</Button>
          {result && (
